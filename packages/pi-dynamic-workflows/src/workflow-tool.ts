...
export function createWorkflowTool(options: WorkflowToolOptions = {}): ToolDefinition<typeof workflowToolSchema, any> {
  return defineTool({
    ...
    promptGuidelines: [
      "Use workflow when the user explicitly asks for a workflow, workflows, fan-out, or multi-agent orchestration, or when the active Skill explicitly requires using workflow. An explicit Skill requirement is sufficient; do not ask for an extra confirmation.",
