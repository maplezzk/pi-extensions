...
| --- | --- | --- |
| [`pi-spec-mode`](./packages/pi-spec-mode) | Specification stages, explicit approval and editing guards. | [English](./packages/pi-spec-mode/README.md) · [中文](./packages/pi-spec-mode/README.zh-CN.md) |
