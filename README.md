...
| [`pi-gen-ui`](./packages/pi-gen-ui) | Renders json-render JSON specs as native Pi terminal panels (tables, charts, callouts, inputs) through a `render_ui` tool, with optional Jev-driven composition. | [English](./packages/pi-gen-ui/README.md) · [中文](./packages/pi-gen-ui/README.zh-CN.md) |
...
| [`pi-metrics`](./packages/pi-metrics) | Shows a live session elapsed timer in the working spinner, then one run summary after the agent stops (`on-stop`, default) or one line per turn (`live`). | [English](./packages/pi-metrics/README.md) · [中文](./packages/pi-metrics/README.zh-CN.md) |
