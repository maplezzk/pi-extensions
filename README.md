...
| --- | --- | --- |
| [`pi-naming`](./packages/pi-naming) | Independent automatic session naming and manual workspace/tab renaming. | [English](./packages/pi-naming/README.md) · [中文](./packages/pi-naming/README.zh-CN.md) |
