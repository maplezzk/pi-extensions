...
| --- | --- | --- |
| [`pi-spec`](./packages/pi-spec) | Specification stages, explicit approval and editing guards. | [English](./packages/pi-spec/README.md) · [中文](./packages/pi-spec/README.zh-CN.md) |
