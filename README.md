...
| [`pi-session-resources`](./packages/pi-session-resources) | Collects files, browser URLs, and PR/MR links from successful tool activity and exposes them through clickable `#` resource autocomplete. | [English](./packages/pi-session-resources/README.md) · [中文](./packages/pi-session-resources/README.zh-CN.md) |
