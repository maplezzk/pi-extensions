...
| 包 | 说明 | 文档 |
| --- | --- | --- |
| [`pi-safety-guards`](./packages/pi-safety-guards) | 可分别配置的危险命令、目录范围和 Maven 守卫。 | [English](./packages/pi-safety-guards/README.md) · [中文](./packages/pi-safety-guards/README.zh-CN.md) |
